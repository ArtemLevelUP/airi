...
class Task extends \AppBundle\Entity\Task implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'estimation', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'deadline', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'creator', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'performer', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'created'];
        }
    ...
    public function setPerformer($performer)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPerformer', [$performer]);
    ...
    public function getPerformer()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPerformer', []);
